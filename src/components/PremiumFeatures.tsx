    ...
    switch (currentLanguage) {
      case 'sr':
        return {
          ...
          advancedNotifications: "Napredna obaveštenja",
          advancedNotificationsDesc: "Prilagođena podsetnika i pametna upozorenja",
          habitReminders: "Podsetnici za navike",
          goalProgressAlerts: "Upozorenja o napretku ciljeva",
          pushNotifications: "Push obaveštenja",
          pushNotificationsDesc: "Obaveštenja u realnom vremenu na vašem uređaju",
          taskDueReminders: "Podsetnici za rokove zadataka",
          habitStreakAlerts: "Upozorenja o seriji navika",
          goalMilestoneNotifications: "Obaveštenja o prekretnicama ciljeva",
          friendChallengeUpdates: "Ažuriranja izazova prijatelja",
          configureNotifications: "Konfiguriši obaveštenja",
          upgradeForPushNotifications: "Nadogradite za push obaveštenja",
          offlineMode: "Offline mod",
          offlineModeDesc: "Radite bez internet konekcije",
          offlineAccess: "Offline pristup",
          syncWhenOnline: "Sinhronizacija kada ste online",
          localStorage: "Lokalno skladište",
          customizableDashboard: "Prilagodljiva kontrolna tabla",
          ...
          aiRecommendationsDesc: "Personalizovane preporuke na osnovu vaših podataka",
          habitSuggestion: "Preporuka navike",
          habitSuggestionDesc: "Na osnovu vaše jutarnje rutine, pokušajte da dodate 'Pijte vodu' kao dnevnu naviku",
          ...
          productivityTipDesc: "Vaše sesije fokusa su najproduktivnije ujutru. Planirajte važne zadatke tada.",
          getNewRecommendations: "Dobijte nove preporuke",
          upgradeForAiInsights: "Nadogradite za AI uvid",
          ...
          groups: "Grupe",
          posts: "Objave",
          shareAchievements: "Podelite dostignuća",
          shareAchievementsDesc: "Podelite svoj napredak na društvenim mrežama",
          shared: "Podeljeno",
          likes: "Lajkovi",
          leaderboards: "Rang liste",
          leaderboardsDesc: "Takmičite se na globalnim i prijateljskim rang listama",
          rank: "Rang",
          points: "Bodovi",
          exploreCommunity: "Istražite zajednicu",
          upgradeForSocialFeatures: "Nadogradite za društvene funkcije",
          premiumContent: "Premium sadržaj",
          premiumContentDesc: "Edukativni i wellness sadržaj",
          wellnessArticles: "Wellness članci",
          wellnessArticlesDesc: "Edukativni sadržaj o zdravlju i wellness-u",
          articles: "Članci",
          ...
          plans: "Planovi",
          allLevels: "Svi nivoi",
          browseContentLibrary: "Pregledajte biblioteku sadržaja",
          upgradeForPremiumContent: "Nadogradite za premium sadržaj",
          ...
          howToPayStep1: "1. Otvorite WeChat aplikaciju na telefonu",
          howToPayStep2: "2. Tapnite 'Skeniraj' i skenirajte QR kod",
          howToPayStep3: "3. Potvrdite iznos plaćanja",
          howToPayStep4: "4. Premium funkcije će biti aktivirane odmah"
        };
      case 'zh':
        return {
          title: "高级功能",
